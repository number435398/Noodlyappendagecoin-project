...
"""Verify that starting noodlyappendagecoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start noodlyappendagecoin with -h for help text")
        ...
        self.log.info("Start noodlyappendagecoin with -version for version information")
