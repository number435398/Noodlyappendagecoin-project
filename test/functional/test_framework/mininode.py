...
"""Noodlyappendagecoin P2P network half-a-node.
...
class P2PConnection(asyncore.dispatcher):
    ...
    def peer_connect(self, dstaddr, dstport, net="regtest"):
        ...
        logger.info('Connecting to Noodlyappendagecoin Node: %s:%d' % (self.dstaddr, self.dstport))
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a Noodlyappendagecoin node.
