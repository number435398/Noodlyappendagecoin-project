...
const char* BIP71_MIMETYPE_PAYMENT = "application/noodlyappendagecoin-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/noodlyappendagecoin-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/noodlyappendagecoin-paymentrequest";
...
{
    QString name("NoodlyappendagecoinQt");
    ...
    if (startLocalServer)
    {
        ...
        if (!uriServer->listen(name)) {
            ...
            QMessageBox::critical(0, tr("Payment request error"),
                tr("Cannot start noodlyappendagecoin: click-to-pay handler"));
        }
        else {
    ...
    if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // bitcoin: URI
    {
        ...
        else // normal URI
        {
            ...
            if (GUIUtil::parseBitcoinURI(s, &recipient))
            {
                ...
                Q_EMIT message(tr("URI handling"),
                    tr("URI cannot be parsed! This can be caused by an invalid Noodlyappendagecoin address or malformed URI parameters."),
                    CClientUIInterface::ICON_WARNING);
