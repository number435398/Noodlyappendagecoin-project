...
UniValue getinfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total noodlyappendagecoin balance of the wallet\n"
...
UniValue createmultisig(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 2)
    {
        std::string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are noodlyappendagecoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) noodlyappendagecoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
