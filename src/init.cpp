...
void Shutdown()
{
    ...
    RenameThread("noodlyappendagecoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/noodlyappendagecoin-project/noodlyappendagecoin>";
    const std::string URL_WEBSITE = "<https://noodlyappendagecoin.org>";
