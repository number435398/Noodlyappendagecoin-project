...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 lites per kB (0.00001 NDL). This is to prepare for dropping the minimum transaction fee to 0.1 lites per kB (0.0001 NDL) in the next release.
