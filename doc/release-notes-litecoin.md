Noodlyappendagecoin Core version *0.15.1* is now available from:

  <https://download.noodlyappendagecoin.org/noodlyappendagecoin-0.15.1/>
...
A number of changes to the way Noodlyappendagecoin Core deals with peer connections and invalid blocks
...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 noodles per kB (0.00001 NDL). This is to prepare for dropping the minimum transaction fee to 0.1 noodles per kB (0.0001 NDL) in the next release.
