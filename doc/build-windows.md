...
for Ubuntu Xenial does not produce working executables for some of the Noodlyappendagecoin Core applications.
...
causes two of the noodlyappendagecoin executables to crash shortly after start up. The bug is related to the
